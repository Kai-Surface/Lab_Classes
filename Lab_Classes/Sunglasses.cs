...
namespace Lab_Classes
{
    ...
    {
        enum Lenses { prescriptiom , reading , mirrored , photochromic , gradient }
        Lenses lenses;
        ...
        enum FrameMaterial { plastic , metal , wwood }
        ...
        private Lenses Lenses1 { get => lenses; set => lenses = value; }
